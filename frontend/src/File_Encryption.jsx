...
const File_Encrypt = () => {
  ...
  async function savePDF () {
    ...
    const lines = doc.splitTextToSize(encryptedText, doc.internal.pageSize.width - margin * 2);
